...
instance ToJSON ModifyGuildIntegrationOpts where
  toJSON ModifyGuildIntegrationOpts {..} = object
    [ ( "expire_grace_period"
      , toJSON modifyGuildIntegrationOptsExpireGraceSeconds
      )
    , ("expire_behavior" , toJSON modifyGuildIntegrationOptsExpireBehavior)
...
instance ToJSON CreateGuildIntegrationOpts where
  toJSON CreateGuildIntegrationOpts {..} =
    object [("type", toJSON createGuildIntegrationOptsType)]
  ...
  toJSON ModifyGuildMemberOpts {..} = object
    ...
    | (name, Just val) <-
      ...
      , ( "communication_disabled_until"
        , toJSON <$> modifyGuildMemberOptsTimeoutUntil
        )
      ]
    ]
...
guildJsonRequest c = case c of
  ...
  (ModifyGuildChannelPositions guild newlocs) ->
    let patch = map
          ...
          newlocs
    in  Patch (guilds // guild /: "channels")
  ...
  (ModifyGuildMember guild member patch) -> Patch
  ...
  (ModifyGuildRole guild role patch) -> Patch
  ...
  (GetGuildWidget guild) -> Get (guilds // guild /: "integrations") mempty
