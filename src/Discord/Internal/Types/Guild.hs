...
instance FromJSON GuildUnavailable where
  parseJSON =
    withObject "GuildUnavailable" $ \o -> GuildUnavailable <$> o .: "id"
...
instance FromJSON ActivityTimestamps where
  parseJSON = withObject "ActivityTimestamps"
    $ \o -> ActivityTimestamps <$> o .:? "start" <*> o .:? "end"
...
instance FromJSON ActivityParty where
  parseJSON = withObject "ActivityParty"
    $ \o -> ActivityParty <$> o .:? "id" <*> o .:? "size"
...
instance FromJSON ActivityButton where
  parseJSON = withObject "ActivityButton"
    $ \o -> ActivityButton <$> o .: "label" <*> o .: "url"
...
instance FromJSON GuildBan where
  parseJSON =
    withObject "GuildBan" $ \o -> GuildBan <$> o .: "reason" <*> o .: "user"
...
instance FromJSON IntegrationAccount where
  parseJSON = withObject "IntegrationAccount"
    $ \o -> IntegrationAccount <$> o .: "id" <*> o .: "name"
...
instance ToJSON GuildWidget where
  toJSON (GuildWidget enabled snowflake) =
    object ["enabled" .= enabled, "channel_id" .= snowflake]
